...
export default function NewsComponent() {
    ...
    const loadAllAnnouncementData = () => {
        SignInService.getAllAnnouncement_News().then((res) => {
            if (res.data.success) {
                setIsSuccess(true);
    ...
    return (
        <div className="row container-fluid">
            <div className="row">
                        ...
                        <div>
                            {
                                ...
                                announcementsNews.map(
                                    (announcement, index) =>  //index is inbuilt variable of map started with 0
                                        <div>
                                            {announcement.announTitle}
                                            <button type="link" className="btn btn-link" data-toggle="modal" data-target="#showNewsData" onClick={() => showAnnouncementgById(announcement.announId)}>Click here</button>
                                        </div>
                ...
                <div className="modal fade" id="showNewsData" role="dialog">
                    <div className="modal-dialog">

                        <div className="modal-content">
                            <div className="modal-header">
                                <button type="button" className="close" data-dismiss="modal">&times;</button>
                                <h4 className="modal-title">News Details</h4>
                            </div>
                            <div className="modal-body">
                                <form className="form-horizontal">
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >News Start Date Time:</label>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >News End Date Time:</label>
                                        <div className="col-sm-8">
                                            {announEndDate}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >News Location:</label>
                                        <div className="col-sm-8">
                                            {announVenue}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >News Title:</label>
                                        <div className="col-sm-8">
                                            {announTitle}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >News Description:</label>
                                        <div className="col-sm-8">
                                            {announDescription}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >News Status:</label>
                                        <div className="col-sm-8">
                                            {announStatus}
                                        </div>
                                    </div>
