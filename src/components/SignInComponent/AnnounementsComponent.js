...
export default function AnnounementsComponent() {
    ...
    const loadAllAnnouncementData = () => {
        SignInService.getAllAnnouncement_Announcement().then((res) => {
            if (res.data.success) {
                setIsSuccess(true);
    ...
    return (
        <div className="row container-fluid">
            <div className="row">
                                ...
                                announcements.map(
                                    (announcement, index) =>  //index is inbuilt variable of map started with 0
                                        <div>
                                            ...
                                            <button type="link" className="btn btn-link" data-toggle="modal" data-target="#showAnnouncementData" onClick={() => showAnnouncementgById(announcement.announId)}>Click here</button>
                                        </div>
                ...
                <div className="modal fade" id="showAnnouncementData" role="dialog">
                    <div className="modal-dialog">

                        <div className="modal-content">
                            <div className="modal-header">
                                <button type="button" className="close" data-dismiss="modal">&times;</button>
                                <h4 className="modal-title">Announcements Details</h4>
                            </div>
                            <div className="modal-body">
                                <form className="form-horizontal">
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Announcement Location:</label>
                                        <div className="col-sm-8">
                                            {announVenue}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Announcement Title:</label>
                                        <div className="col-sm-8">
                                            {announTitle}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Announcement Description:</label>
                                        <div className="col-sm-8">
                                            {announDescription}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Announcement Status:</label>
                                        <div className="col-sm-8">
                                            {announStatus}
                                        </div>
                                    </div>
