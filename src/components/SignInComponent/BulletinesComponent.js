...
export default function BulletinesComponent() {
                                ...
                                announcements.map(
                                    (announcement, index) =>  //index is inbuilt variable of map started with 0
                                        <div>
                                            ...
                                            <button type="link" className="btn btn-link" data-toggle="modal" data-target="#showData" onClick={() => showAnnouncementgById(announcement.announId)}>Click here</button>
                                        </div>
                    ...
                    <div className="modal-dialog">
                        ...
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title">Bulletines Details</h4>
                            </div>
                            <div className="modal-body">
                                <form className="form-horizontal">
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Bulletines Start Date Time:</label>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Bulletines End Date Time:</label>
                                        <div className="col-sm-8">
                                            {announEndDate}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Bulletines Location:</label>
                                        <div className="col-sm-8">
                                            {announVenue}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Bulletines Title:</label>
                                        <div className="col-sm-8">
                                            {announTitle}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Bulletines Description:</label>
                                        <div className="col-sm-8">
                                            {announDescription}
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label className="control-label col-sm-4" htmlFor="deptName" >Bulletines Status:</label>
                                        <div className="col-sm-8">
                                            {announStatus}
                                        </div>
                                    </div>
